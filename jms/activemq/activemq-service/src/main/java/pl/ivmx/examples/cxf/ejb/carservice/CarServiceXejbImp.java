 ...
 */
@Stateless(name = "carServiceEJBJMSXXXX", mappedName = "carServiceEJBJMSXXXX")
@Local(CarServiceEJBJMS_I.class)
public class CarServiceXejbImp implements CarServiceEJBJMS_I {
    private final Logger log = Logger.getLogger(CarServiceXejbImp.class);
