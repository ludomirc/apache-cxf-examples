...
import pl.ivmx.examples.cxf.service.schema.ObjectFactory;
import pl.ivmx.examples.cxf.service.schema.Type;
 ...
 */
@Stateless(name = "carServiceFirstRestEjb", mappedName = "carServiceFirstRestEjb")
...
public class CarServiceImp implements CarServiceEJB_I {
    ...
    protected ObjectFactory oFactory = new ObjectFactory();
