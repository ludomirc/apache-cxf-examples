package pl.ivmx.examples.cxf.contractfirst.web;
...
public class CarServiceImp implements CarServiceI {
    ...
    protected CarServiceEJB_I carServiceEjb = JndiUtils.getLocalEJB("java:global//carServiceFirstEjb!pl.ivmx.examples.cxf.ejb.carservice.CarServiceEJB_I");
